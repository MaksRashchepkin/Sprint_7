...
@allure.epic("Тестирование на логин курьеров")
class TestLoginCourier:
    ...
    @allure.title("Тест на логин с некорректными данными")
    ...
    @allure.description("Создание курьера, затем проверка, что курьер может успешно войти в систему и, что успешный запрос возвращает id.")
